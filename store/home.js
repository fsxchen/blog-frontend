...
export const actions = {
  ...
  UPDATE_HOME_META({
    ...
    commit('UPDATE_DOCUMENT_TITLE', '首页', {
      root: true
    });
    commit('UPDATE_DOCUMENT_DESCRIPTION', rootState.base.siteInfo.desc, {
      root: true
    });
    commit('UPDATE_DOCUMENT_KEYWORDS', rootState.base.siteInfo.keywords, {
      root: true
    });
  },
  // 获取部分单级分类，不包括子级分类
  GET_TOP_LEVEL_CATEGORIES_INFO({
    state,
    commit,
    rootState
  }, params) {
