            ...
            <i-col :xs="cellRightSpan('xs')" :sm="cellRightSpan('sm')" :md="cellRightSpan('md')"
              ...
              <div class="content">
                <p class="title">
                  ...
                  <span class="reply-icon" :class="theme" v-if="comment.reply_to_author !== null"><Icon
                    type="forward"></Icon></span>
                ...
                <div class="operate-area" :class="theme">
                  <span class="like" @click="likeComment(comment)"><Icon type="thumbsup"></Icon> {{ comment.like_num }}</span>
                  <span class="unlike" @click="unlikeComment(comment)"><Icon type="thumbsdown"></Icon> {{ comment.unlike_num }}</span>
                  <span class="reply"><a @click="showEditor = !showEditor"><Icon
                    type="forward"></Icon> {{ $t('comments.reply') }}</a></span>
                  <!--<i-dropdown>-->
                  <!--<span class="i-dropdown-link">-->
                  <!--<Icon type="android-share-alt"></Icon> 分享 <Icon type="arrow-down-b"></Icon>-->
                  <!--</span>-->
...
<style lang="stylus" type="text/stylus" rel="stylesheet/stylus">
  ...
  @import "../../../assets/style/comment.styl";
