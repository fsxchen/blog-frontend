<template>
  <div class="album-carousel">
    <p class="top-bar">
      <Icon type="android-close" @click.native="close"></Icon>
      <Icon type="android-expand" @click.native="expand"></Icon>
      <Icon type="ios-download-outline" @click.native="download"></Icon>
    </p>
