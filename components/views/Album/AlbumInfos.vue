<template>
  <div class="album-infos">
    <p class="operate_info">
      <span class="readings"><a><Icon type="eye"></Icon> {{ album.click_num }} 阅读</a></span>
      <span class="comments"><a><Icon type="compose"></Icon> {{ album.comment_num }} 评论</a></span>
      <span class="likes"><a @click="likePost(album)"><Icon type="heart"></Icon> {{ album.like_num }} 喜欢</a></span>
    </p>
    <div class="author">
      <a href="">
