  ...
  <div class="section-title">
    <div class="title">
      ...
      <span class="view-more" v-if="to !== undefined" @click="tipAction">
        <a>
          {{tipText ? tipText : $t('common.viewmore')}} <Icon type="arrow-right-b"></Icon>
        </a>
      </span>
    </div>
    <div class="menu">
      ...
      <div class="date-picker" v-if="withTimeSelect">
        <DatePicker type="daterange" :options="datePickerOptions" confirm :split-panels="true" placement="bottom-end" :placeholder="$t('common.inputPlaceholder.selectDataRange')" @on-clear="clearDateSelect" @on-ok="comfirmDateSelect" @on-change="changeDate"
