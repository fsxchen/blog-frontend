<template>
  <div class="article-page-header" v-if="article !== undefined">
    <div class="status">
      <div class="tags">
        <Tag color="blue" v-for="tag in article.tags" :key="tag.id" class="dot-tag">{{tag[resolveI18N('name')]}}</Tag>
      </div>
    ...
    <Row>
      ...
      <i-col :xs="24" :sm="14" :md="14" :lg="14" style="padding-left: 0;padding-right: 0;">
        <p class="operate_info">
          ...
          <span class="comments"><a @click="scrollToComments"><Icon type="compose"></Icon> {{article.comment_num}} {{ $t("article.comments") }}</a></span>
...
<script type="text/ecmascript-6">
  ...
  // mixin
  import {mixin, saveToLocal} from '@/utils/js/utils';
